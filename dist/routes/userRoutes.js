...
router.put('/user/last-viewed', async (req, res) => {
    ...
    try {
        const historyResult = await pool.query('UPDATE users SET last_viewed_tasks = $1 WHERE id = $2 RETURNING last_viewed_tasks', [lastViewed, userId]);
